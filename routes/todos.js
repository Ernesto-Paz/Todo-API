module.exports = function(db, middleware){
    ...
    router.get("/todos", middleware.requireAuth, function (req, res) {
    var todosArray = []
...
router.get("/todos/:id", middleware.requireAuth, function (req, res) {
...
router.post("/todos", middleware.requireAuth, function (req, res) {
...
router.delete("/todos/:id", middleware.requireAuth, function (req, res) {
    var reqId = parseInt(req.params.id, 10);
...
router.put("/todos/:id", middleware.requireAuth, function (req, res) {
